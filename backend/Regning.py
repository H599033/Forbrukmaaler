...
class Regning:
    def __init__(self, bokført: str, rentedato: str, type: str, beskrivelse: str, melding: str,
    ...
    def __repr__(self):
        return (f"Regning(bokført={self.bokført}, rentedato={self.rentedato}, type='{self.type}', "
